...
const TableNameAppRechargeTx = "app_recharge_tx"

var AppRechargeTxColumns = struct {
	ID              FieldBase
	AppKey          FieldBase
...
// TableName AppRechargeTx's table name
func (*AppRechargeTx) TableName() string {
	return TableNameAppRechargeTx
}
