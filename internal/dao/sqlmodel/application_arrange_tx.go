...
type ApplicationArrangeTx struct {
	...
	FromAddress     string  `json:"from_address" gorm:"column:from_address;type:varchar(200);not null"`         //整理钱包地址
	ToAddress       string  `json:"to_address" gorm:"column:to_address;type:varchar(200);not null"`             //冷钱包收款地址
